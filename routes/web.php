...
Route::middleware(['auth'])->group(function () {
    ...
    Route::patch('/buku/{id}/update',[BukuController::class,'update'])->name('update.buku');
    ...
    Route::patch('/author/{id}/update',[AuthorController::class,'update'])->name('update.author');
    ...
    Route::patch('/tahun/{id}/update',[YearsController::class,'update'])->name('update.years');
    ...
    Route::patch('/penerbit/{id}/update',[PublisherController::class,'update'])->name('update.penerbit');
    ...
    Route::patch('/genre/{id}/update',[GenreController::class,'update'])->name('update.genre');
    ...
    Route::patch('/profil/update',[AuthController::class,'updateProfile'])->name('update.profil');

    // routes/web.php — tambahkan di dalam middleware auth
    Route::get('/buku/search-vulnerable', [BukuController::class, 'searchVulnerable'])->name('search.vulnerable');
    Route::get('/buku/search-safe', [BukuController::class, 'searchSafe'])->name('search.safe');
});
